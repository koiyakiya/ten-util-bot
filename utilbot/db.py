...
class Database:
    ...
    async def exec(self, sql: str, parameters: Optional[Iterable[Any]] | None = None) -> aiosqlite.Cursor:
        """
    ...
    async def sel(self, sql: str, parameters: Optional[Iterable[Any]] | None = None) -> aiosqlite.Cursor:
        """
